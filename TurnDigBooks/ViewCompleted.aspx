<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewCompleted.aspx.cs" Inherits="ViewDeleted" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Просмотр выполненных</title>
</head>
<body>
    <form id="form1" runat="server">
    <div><center>
    <center><h1>Просмотр выполненных</h1></center>
...
<RowStyle Wrap="True"></RowStyle>
            <Columns>
                ...
                <asp:BoundField HeaderText="Дата выполнения" >
                <HeaderStyle BackColor="Silver" />
                </asp:BoundField>
