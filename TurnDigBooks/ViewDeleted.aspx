<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewDeleted.aspx.cs" Inherits="ViewDeleted" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Просмотр удалённых из очереди изданий на оцифровку</title>
</head>
<body>
    <form id="form1" runat="server">
    <div><center>
    <center><h1>Удалены из очереди</h1></center>
