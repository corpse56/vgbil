...
public partial class ViewDeleted : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DA.SelectCommand.CommandText = "with main as ( select row_number() over (order by (A.DELDATE )) num,A.IDMAIN pin,case when A.BAZA = 1 then avtp.PLAIN else ravtp.PLAIN end avt, CC.[DateEBook] dd," +
