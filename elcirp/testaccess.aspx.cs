...
public partial class testaccess : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string[] imagenames;

        using (new NetworkConnection(@"\\192.168.4.30\BookAddInf", new NetworkCredential("BJStor01\\imgview", "Image_123Viewer")))
        {

            imagenames = System.IO.Directory.GetFiles(@"\\\\192.168.4.30\\BookAddInf\\PERIOD\\0\\001\\140\\1937\\№ 372", "*.jpg");

            Label1.Text = imagenames.Length.ToString();
        }
    }
    /// <summary>
