...
namespace ALISAPI.Controllers
{
    public class ReadersController : ApiController
    {
        ...
        //string RegisterConnectionString = @"Data Source=127.0.0.1;Initial Catalog=Readers;Integrated Security=True;";
        string RegisterConnectionString = AppSettings.ConnectionString;
