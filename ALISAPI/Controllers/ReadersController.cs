...
namespace ALISAPI.Controllers
{
    public class ReadersController : ApiController
    {
        ...
        string RegisterConnectionString = AppSettings.ConnectionString;// "Data Source=192.168.4.25,1443;Initial Catalog=Readers;Persist Security Info=True;User ID=sasha;Password=Corpse536;Connect Timeout=1200";
        /// <summary>
