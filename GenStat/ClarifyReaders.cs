...
namespace GenStat
{
    public partial class ClarifyReaders : Form
    {
        string dep;
        StatDB DB;
        public ClarifyReaders(string dep_,StatDB DB_)
        {
            InitializeComponent();
            this.dep = dep_;
            this.DB = DB_;
        ...
        private void ShowFreeServicesByUsers()
        {
            ...
            ClarGrid.DataSource = DB.GetReadersByVarcharDEP(this.dep); ;
            Type ttt = ((DataTable)ClarGrid.DataSource).Columns[5].DataType;
            ...
            //ClarGrid.Columns[5].DefaultCellStyle.Format = "dd.MM.yyyy";
            Autoinc();
        }
        ...
        private void bPrint_Click(object sender, EventArgs e)
        {
            ...
            repform = new Rep(dt, label1.Text + " " + label2.Text,10);
            repform.ShowDialog(); 
        }
