    ...
    public class AppSettings
    {
        static public string ConnectionString
        {
            get
            {
                ...
                string connectionString = "Data Source=192.168.1.82,1442;Initial Catalog=Readers;Persist Security Info=True;User ID=sasha;Password=Corpse536;Connect Timeout=1200";
        ...
        static public string StatisticsConnectionString
        {
            get
            {
                ...
                string connectionString = "Data Source=192.168.1.81,1441;Initial Catalog=Readers;Persist Security Info=True;User ID=sasha;Password=Corpse536;Connect Timeout=1200";
                return connectionString;
            }
        }
