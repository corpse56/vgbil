...
public class Service : System.Web.Services.WebService
{
    ...
    [WebMethod(Description = "Возвращает номер читателя при успешной авторизации. Во всех остальных случаях генерируется исключение. Если пользователь не найден или входной параметр имеет неправильный формат, генерируется исключение. Возможные исключения: "+
