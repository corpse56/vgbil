...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <center>
            <br />
            <asp:Label ID="Label1" runat="server" ForeColor ="Red" Font-Size ="XX-Large" Text="Уважаемые читатели! По техническим причинам Библиотека временно приостановит обслуживание читателей с 26 декабря 2018 года и до конца января 2019 годаС 26 декабря 2018 и до конца января 2019." >
                </asp:Label>
                <br />
