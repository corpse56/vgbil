                    ...
                    case "899$p": //КАК УЗНАТЬ, ЧТО ИНВЕНТАРЬ ОФ ИЛИ АБОНЕМЕНТ?
                        {
                            if (!isExistIn(r["IDDATA"].ToString(), anotherActs))
                            {
                                if ((r["fnd"].ToString() == "Абонемент") || (r["mhr"].ToString() == "ЦДДАбонемент") || (r["act"].ToString().IndexOf("АБ") != -1))
                                {
                                    ...
                                    if ((r["fnd"].ToString().Contains("БиблиотекаЭстерхазиАвстрия")) || (r["fnd"].ToString() == "Фондредкойкниги") || (r["mhr"].ToString() == "КнигохранениеФондредкойкниги") || (r["act"].ToString().IndexOf("R") != -1))
                                    {
                    ...
                    case "899$j":
                        {
                            ...
                            if ((r["fnd"].ToString() == "КнигохранениеФондредкойкниги") || (r["fnd"].ToString().Contains("БиблиотекаЭстерхазиАвстрия")))
                            {
                            ...
                            /*if (r["act"].ToString().IndexOf("ОК") != -1)
                            {
                                if (this.book_.ReferenceNumberR != null)
                                {
                                    if (this.book_.ReferenceNumberOF.IndexOf(r["PLAIN"].ToString()) == -1)
