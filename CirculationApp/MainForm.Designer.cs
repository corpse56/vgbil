namespace CirculationApp
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.bChangeAuthorization.Text = "—менить сотрудника";
            ...
            this.lBooksCountInHall.Text = "¬ыдано в зал: ";
            // 
            // bMainEmulation
            // 
            ...
            this.bMainEmulation.Text = "эмул€ци€";
            ...
            this.bReaderRegistration.Text = "¬ыдать права бесплатного абонемента";
            ...
            this.bRemoveResponsibility.Text = "—н€ть ответственность";
            ...
            this.bFormularSendEmail.Text = "ќтослать email";
            ...
            this.bProlong.Text = "ѕродлить выделенное";
            ...
            this.bSearchReaderByFIO.Text = "ѕоиск читател€ по фамилии";
            ...
            this.bReaderView.Text = "ѕросмотр сведений о читателе";
            ...
            this.bOrdersHistory.Text = "»стори€ выдач";
            ...
            this.bFormularFindById.Text = "Ќайти";
            ...
            this.lInfoAttendance.Text = "—читайте штрихкод читател€, чтобы увеличить посещаемость";
            // 
            // lAttendance
            // 
            ...
            this.lAttendance.Text = "Ќа сегодн€ посещаемость составл€ет: 0 человек(а)";
            // 
            // AcceptBooksTab
            // 
            ...
            this.label2.Text = "—читайте штрихкод, чтобы прин€ть книгу на кафедру";
            // 
            // bEmulationTransfer
            // 
            ...
            this.bEmulationTransfer.Text = "Ёмул€ци€";
            ...
            this.label10.Text = " ниговыдача ¬√Ѕ»Ћ";
            // 
            // contextMenuStrip2
            // 
            ...
            this.истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem});
            this.заказToolStripMenuItem.Name = "заказToolStripMenuItem";
            this.заказToolStripMenuItem.Size = new System.Drawing.Size(49, 20);
            this.заказToolStripMenuItem.Text = "«аказ";
            // 
            // истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem
            // 
            this.истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem.Name = "истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem";
            this.истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem.Size = new System.Drawing.Size(310, 22);
            this.истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem.Text = "»стори€ заказов по инвентарному номеру";
            this.истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem.Click += new System.EventHandler(this.InvNumberOrderHistoryToolStripMenuItem_Click);
            // 
            // pbLogo
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem истори€«аказовѕо»нвентарномуЌомеруToolStripMenuItem;
